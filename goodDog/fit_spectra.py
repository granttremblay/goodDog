...
def fit_sherpa(obsid_list, redshift, nH_Gal, lo_energy, hi_energy, min_counts = 25, kT_guess = 3, Ab_guess = 1, fix_nH_Gal=True, fix_abund=False, find_errors=True):
	...
	for i in range(num_reg):
		...
		for j in range(num_obs):
			...
			sherpa.ignore_id(data_set, 0.0, lo_energy)
			sherpa.ignore_id(data_set, hi_energy, None)
			cnts[j] = sherpa.calc_data_sum(lo_energy, hi_energy, data_set)
		...
		results_file.write('%7r %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %6.4e %6.4e %6.4e %7.4f %7.4f %7.4f %7.4f %8.1f %8r\n' % (i, kT, kT_loerr, kT_hierr, Z, Z_loerr, Z_hierr, norm, norm_loerr, norm_hierr, nH, nH_loerr, nH_hierr, red_chi2, totcnts, num_bins) ) # Write all data to a file
...
fit_sherpa(obsids, redshift, nH_Gal, lo_energy, hi_energy)
